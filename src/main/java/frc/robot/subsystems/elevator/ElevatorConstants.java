...
public class ElevatorConstants {
    ...
    static {
        ...
        elevatorConfig.MotionMagic.MotionMagicAcceleration = 4.75;
    ...
    public static final double ELEVATOR_DEALGAE_UPPER_POS = 2.2;
    public static final double ELEVATOR_DEALGAE_LOWER_POS = 1.2;
